...
(function (a, b) {
    ...
    typeof a == "undefined" ? (d = exports, e = c("less/tree")) : (typeof a.less == "undefined" && (a.less = {}), d = a.less, e = a.less.tree = {}), d.Parser = function (a) {
        ...
        a.Call = function (a, b) {
            this.name = a, this.args = b
        }, a.Call.prototype = {eval: function (b) {
            var c = this.args.map(function (a) {
                return a.eval(b)
            });
            return this.name in a.functions ? a.functions[this.name].apply(a.functions, c) : new a.Anonymous(this.name + "(" + c.map(function (a) {
                return a.toCSS()
            }).join(", ") + ")")
        }, toCSS: function (a) {
        ...
        a.mixin = {}, a.mixin.Call = function (b, c, d) {
            ...
            var b, c = [], d = !1;
            for (var e = 0; e < a.frames.length; e++)if ((b = a.frames[e].find(this.selector)).length > 0) {
                for (var f = 0; f < b.length; f++)if (b[f].match(this.arguments, a))try {
                    Array.prototype.push.apply(c, b[f].eval(a, this.arguments).rules), d = !0
                } catch (g) {
                    throw{message: g.message, index: g.index, stack: g.stack, call: this.index}
                }
                if (d)return c;
        ...
        a.Quoted = function (a, b, c, d) {
            ...
            var c = this;
            this.value = this.value.replace(/`([^`]+)`/g,function (d, e) {
                return(new a.JavaScript(e, c.index, !0)).eval(b).value
            }).replace(/@\{([\w-]+)\}/g, function (d, e) {
                return(new a.Variable("@" + e, c.index)).eval(b).value
            });
            return this
        }}
    }(c("less/tree")), function (a) {
        ...
        a.Selector = function (a) {
            ...
            return this._css = this.elements.map(function (b) {
